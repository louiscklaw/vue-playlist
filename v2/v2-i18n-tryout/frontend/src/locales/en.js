export default {
  ...
  welcome: {
    ...
    messages: ["There is no server.", "You can create/import a server or import a subscription."],
  },
  v2ray: {
    start: "Start",
    stop: "Stop",
  ...
  server: {
    ...
    messages: {
      notAllowInsecure: "According to the docs of {name}, if you use {name}, AllowInsecure will be forbidden.",
  ...
  InSecureConfirm: {
    ...
    message: "The configuration has set the <b>AllowInsecure</b> to true. This may cause security risks. Are you sure to continue?",
  ...
  setting: {
    ...
    messages: {
      gfwlist: "Based on modified time of file which sometimes is after latest version online.",
      transparentProxy:
      ...
      preventDnsSpoofing:
        "★Forward DNS Request: DNS requests will be forwarded by proxy server." + "★DoH(dns-over-https, v2ray-core: 4.22.0+): DNS over HTTPS.",
      specialMode:
  ...
  delete: {
    ...
    message: "Be sure to <b>DELETE</b> those servers/subscriptions? It is not reversible.",
  },
  latency: {
    message: "Latency tests used to cost one or several minutes. Wait patiently please.",
  },
  version: {
    higherVersionNeeded: "This operation need higher version of v2rayA than {version}",
    v2rayInvalid: "geosite.dat, geoip.dat or v2ray-core may not be installed correctly",
    v2rayNotV5: "The version of v2ray-core is not v5. Use v5 or downgrade v2rayA to v1.5",
  },
  ...
  axios: {
    messages: {
      ...
      noBackendFound: "Cannot find v2rayA at {url}. Make sure v2rayA is running at this address.",
      cannotCommunicate: [
  ...
  outbound: {
    ...
    deleteMessage: 'Be sure to <b>DELETE</b> the outbound "{outboundName}"? It is not reversible.',
  },
  log: {
